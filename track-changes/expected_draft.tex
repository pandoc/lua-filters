...
A \protect\note[id=MCW]{I agree!}\protect\hlnote{\textbf{simple}} comment from me.
...
Here is a \protect\note[id=JFK]{Why?}\protect\hlnote{com\added[id=SWS]{m}ent with nest\deleted[id=FKA]{t}ed changes}.
...
This is \protect\note[id=MCW]{A comment across paragraphs.}\protect\hlnote{a new paragraph.

And so} is this.

One \protect\note[id=JR]{This one has multiple paragraphs. \newline \newline See?}\protect\hlnote{more}.

\hypertarget{a-header-with-a-notecomment}{%
\section{\texorpdfstring{A header with a \protect\note[id=MFW]{Note}\protect\hlnote{comment}}{A header with a comment}}\label{a-header-with-a-notecomment}}
